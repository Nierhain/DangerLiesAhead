...
import de.nierhain.dangerliesahead.capabilities.spawned.ProviderSpawned;
...
import static de.nierhain.dangerliesahead.capabilities.spawned.ProviderSpawned.CAPABILITY_SPAWNED;
...
public class MobSpawnHandler {
    ...
    public void attachCapabilities(AttachCapabilitiesEvent<Entity> event) {
        if (event.getObject() instanceof IMob) {
            event.addCapability(new ResourceLocation("dangerliesahead", "spawned"), new ProviderSpawned());
        }
    }
