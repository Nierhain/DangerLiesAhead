...
import de.nierhain.dangerliesahead.network.PacketAttributeToServer;
...
public class GuiSkill extends GuiScreen {
    ...
    private final ResourceLocation skills = new ResourceLocation(DangerLiesAhead.MODID, "textures/gui/skills.png");
    private final ResourceLocation skillButtonTexture = new ResourceLocation(DangerLiesAhead.MODID, "textures/gui/skill_button.png");
    private final ResourceLocation infoTexture = new ResourceLocation(DangerLiesAhead.MODID, "textures/gui/info.png");
